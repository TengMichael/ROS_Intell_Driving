...
void kf_calc(kf_radar_mobileye::radar_mobileye_data *measure_value){
  ...
  ROS_INFO("fusion_VrelX %f",kf.x_(2));
  ROS_INFO("fusion_VrelY %f",kf.x_(3));
  ROS_INFO("fusion_DistX %f",kf.x_radar(0));
  ROS_INFO("fusion_DistY %f",kf.x_radar(1));
  ROS_INFO("fusion_VrelX %f",kf.x_radar(2));
  ROS_INFO("fusion_VrelY %f",kf.x_radar(3));
