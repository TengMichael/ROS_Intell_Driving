...
void YoloObjectDetector::init()
{
  ...
  nodeHandle_.param("weights_path", weightsPath, std::string("darknet_ros/yolo_network_config/weights"));
  ...
  nodeHandle_.param("config_path", configPath, std::string("darknet_ros/yolo_network_config/cfg"));
