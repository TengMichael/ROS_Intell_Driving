...
public:
  vehicle();//默认构造函数
  vehicle(double len,double width, double cur_spd,double preferred_speed, double max_a,double max_d, double max_angle);//构造函数
...
public:
  ...
  vec2d GPS_in_road_section;//下一路段入口处GPS位置
  vec2d GPS_out_road_section;//当前路段出口GPS位置
