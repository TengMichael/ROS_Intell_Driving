...
if("TRUE" STREQUAL "TRUE")
  set(fusion_SOURCE_PREFIX /home/michael/Desktop/Intell_driving/ROS_Intell_Driving/src/fusion)
  set(fusion_DEVEL_PREFIX /home/michael/Desktop/Intell_driving/ROS_Intell_Driving/devel)
  set(fusion_INSTALL_PREFIX "")
  set(fusion_PREFIX ${fusion_DEVEL_PREFIX})
else()
  set(fusion_SOURCE_PREFIX "")
  set(fusion_DEVEL_PREFIX "")
  set(fusion_INSTALL_PREFIX /home/michael/Desktop/Intell_driving/ROS_Intell_Driving/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'fusion' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'root <root@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'fusion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/michael/Desktop/Intell_driving/ROS_Intell_Driving/src/fusion/${idir}'.  Ask the maintainer 'root <root@todo.todo>' to fix it.")
    endif()
...
set(fusion_EXPORTED_TARGETS "fusion_generate_messages_cpp;fusion_generate_messages_lisp;fusion_generate_messages_py")
